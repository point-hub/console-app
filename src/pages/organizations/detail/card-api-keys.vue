...
const prefixOrganization = defineModel('prefixOrganization')
...
const onRegenerate = async () => {
  ...
  // start api call
  const response = await axios.patch(`/v1/organizations/${formId.value}/regenerate`)
  if (response.status === 200) {
    emit('regenerated', response.data.api_key)
    prefixOrganization.value = response.data.prefix_api_key
        ...
        <div class="flex flex-wrap gap-4 w-full justify-between">
          ...
          >
            <div class="max-h-90vh overflow-auto p-4">
              <h2 class="py-4 text-2xl font-bold">Regenerate Organization</h2>
              <div class="space-y-8">
                <p>
                  Are you sure you want to regenerate this Organization? Any applications or scripts
                  using this Organization will no longer be able to access the Auth API. You cannot
                  undo this action.
                </p>
                <div class="flex gap-2">
                  ...
                  >
                    I Understand, Regenerate this Organization.
                  </base-button>
                  <base-button
                    color="secondary"
                    size="sm"
