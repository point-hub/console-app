...
const onDelete = async () => {
  ...
  // start api call
  const response = await axios.delete(`/v1/organizations/${id.value}`)
...
<template>
  <base-modal :is-open="showModal" @on-close="toggleModal(false)">
    <div class="max-h-90vh overflow-auto p-4">
      <h2 class="py-4 text-2xl font-bold">Delete Organization</h2>
      <div class="space-y-8">
        <p>
          Are you sure you want to delete this Organization? Any applications or scripts using this
